# STRAND — User Flow Diagrams — Orchestration

| Field             | Value                                       |
| ----------------- | ------------------------------------------- |
| Project codename  | HELIX                                       |
| Working title     | STRAND                                      |
...
This document is the binding UX specification for STRAND. It maps every screen the player can reach and every transition between them. It is the final required deliverable of Phase 1 Pre-Production per the studio framework.
...
- [STRAND — Game Design Document.md](STRAND%20—%20Game%20Design%20Document.md) — creative source of truth
- [STRAND — Technical Design Document.md](STRAND%20—%20Technical%20Design%20Document.md) — engineering source of truth
- [STRAND — Concept One-Pager.md](STRAND%20—%20Concept%20One-Pager.md) — pitch source of truth
- `STRAND — Economy.xlsx` — numeric source of truth
...
| - | -------------------------- | -------------------------------------------------------------------------------- | --------------------------- |
| 1 | First-Launch Flow          | [STRAND — User Flow — 01 First-Launch.md](STRAND%20—%20User%20Flow%20—%2001%20First-Launch.md)                       | S001-S016, S100             |
| 2 | Core Run Loop              | [STRAND — User Flow — 02 Core Run Loop.md](STRAND%20—%20User%20Flow%20—%2002%20Core%20Run%20Loop.md)                 | S017-S033                   |
| 3 | Combat Sub-Flow            | [STRAND — User Flow — 03 Combat Sub-Flow.md](STRAND%20—%20User%20Flow%20—%2003%20Combat%20Sub-Flow.md)               | S040-S052                   |
| 4 | Strand Event Sub-Flow      | [STRAND — User Flow — 04 Strand Event Sub-Flow.md](STRAND%20—%20User%20Flow%20—%2004%20Strand%20Event%20Sub-Flow.md) | S060-S071                   |
| 5 | Meta-Progression Screens   | [STRAND — User Flow — 05 Meta-Progression.md](STRAND%20—%20User%20Flow%20—%2005%20Meta-Progression.md)               | S080-S111                   |
| 6 | Monetization Flows         | [STRAND — User Flow — 06 Monetization.md](STRAND%20—%20User%20Flow%20—%2006%20Monetization.md)                       | S120-S135                   |
| 7 | Edge Cases                 | [STRAND — User Flow — 07 Edge Cases.md](STRAND%20—%20User%20Flow%20—%2007%20Edge%20Cases.md)                         | E001-E052                   |
| 8 | Share Flow                 | [STRAND — User Flow — 08 Share Flow.md](STRAND%20—%20User%20Flow%20—%2008%20Share%20Flow.md)                         | S140-S150 + ATTR + LANDING  |
...
| Field                       | Value                                                |
| --------------------------- | ---------------------------------------------------- |
| Document                    | STRAND — User Flow Diagram v1.0                      |
| Version                     | 1.0                                                  |
