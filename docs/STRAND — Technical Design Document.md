# STRAND — Technical Design Document
...
| SDK           | Purpose                                                                                            |
| ------------- | -------------------------------------------------------------------------------------------------- |
| AdMob         | Only ad SDK approved for STRAND. Rewarded video only. No banners, no interstitials.                |
...
| Field      | Value                                                              |
| ---------- | ------------------------------------------------------------------ |
| Document   | STRAND — Technical Design Document                                 |
| Version    | 1.0 (consolidated)                                                 |
