...
export type Effect =
  ...
  | { readonly type: 'damageDealt'; readonly targetId: string; readonly amount: number; readonly isCrit: boolean; readonly damageType: string }
  ...
  | { readonly type: 'statusApplied'; readonly targetId: string; readonly status: string; readonly turns: number }
  | { readonly type: 'statusExpired'; readonly targetId: string; readonly status: string }
